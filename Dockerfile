...
# On k8s, assume the movim daemon is running as a sidecar and connect there.
# When running in docker-compose, set this variable in your docker-compose.yaml to `daemon`.
